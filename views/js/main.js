...
//SS: added pizza sizes array for to avoid calculating values
var pizzaSizes = [
    { label: 'Small', size: '25%' },
    { label: 'Medium', size: '33%' },
    { label: 'Large', size: '50%' }
];
//SS: cache elements to avoid traversing dom each time in the loop
var elemPizzaSizeLabel = document.querySelector("#pizzaSize");
var elemsPizzaContainer = document.getElementsByClassName('randomPizzaContainer');
...
var resizePizzas = function(size) {
    ...
    //SS:  get value of lable form array
    elemPizzaSizeLabel.innerHTML = pizzaSizes[size].label;

    // Iterates through pizza elements on the page and changes their widths
    function changePizzaSizes(size) {
        for (var i = 0; i < elemsPizzaContainer.length; i++) {
            //SS: commnted below code to stop reflow
            //var dx = determineDx(document.querySelectorAll(".randomPizzaContainer")[i], size);
            //var newwidth = (document.querySelectorAll(".randomPizzaContainer")[i].offsetWidth + dx) + 'px';
            //SS: Get new width from the pizzaSizes array
            elemsPizzaContainer[i].style.width = pizzaSizes[size].size;
        }
    }
...
//SS: moved get alement outside the loop
...
function updatePositions() {
    ...
    //SS: moved calculations out of loop
    var phase = [];
    ...
    //SS: use getElementsByClassName as it more efficient
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // max number of pizzas  = vp /(approx s) * col + additional col just in case 
    totalPizza = (intViewportHeight / s) * (cols + 1)
    ...
    //SS: added requestanimationframe call
