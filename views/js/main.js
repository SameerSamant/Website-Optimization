...
var resizePizzas = function(size) {
  ...
  // }
    ...
    document.querySelector("#pizzaSize").innerHTML = pizzaSizes[size].label;
  ...
  function changePizzaSizes(size) {
    for (var i = 0; i < document.querySelectorAll(".randomPizzaContainer").length; i++) {
      ...
      document.querySelectorAll(".randomPizzaContainer")[i].style.width = pizzaSizes[size].size;
    }
  }
...
function updatePositions() {
  ...
  var con = (document.body.scrollTop / 1250);
